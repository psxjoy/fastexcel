 ...
 *
 * <p>Verifies that the no-model read example can read {@code demo.xlsx} without a pre-defined
 * data class, using {@code Map<Integer, String>} to receive each row's data.
 */
