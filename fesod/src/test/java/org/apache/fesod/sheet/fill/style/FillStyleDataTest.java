...
package org.apache.fesod.sheet.fill.style;
...
public class FillStyleDataTest {
    ...
    private void t01Fill07check(XSSFRow row) {
        ...
        Assertions.assertEquals(
                "FF00B050", cell0.getCellStyle().getFillForegroundColorColor().getARGBHex());
        Assertions.assertEquals(
                "FF7030A0", cell0.getCellStyle().getFont().getXSSFColor().getARGBHex());
        ...
        Assertions.assertEquals(
                "FF92D050", cell1.getCellStyle().getFillForegroundColorColor().getARGBHex());
        Assertions.assertEquals(
                "FF4BACC6", cell1.getCellStyle().getFont().getXSSFColor().getARGBHex());
        ...
        Assertions.assertEquals(
                "FFFFC000", cell2.getCellStyle().getFillForegroundColorColor().getARGBHex());
        Assertions.assertEquals(
                "FFC0504D", cell2.getCellStyle().getFont().getXSSFColor().getARGBHex());
    ...
    private void t02Fill03check(HSSFWorkbook workbook, HSSFRow row) {
        ...
        Assertions.assertEquals(49, cell0.getCellStyle().getDataFormat());
        Assertions.assertEquals(
                "0:8080:0", cell0.getCellStyle().getFillForegroundColorColor().getHexString());
        Assertions.assertEquals(
                "8080:0:8080",
        ...
        Assertions.assertEquals(
                "9999:CCCC:0",
                cell1.getCellStyle().getFillForegroundColorColor().getHexString());
        Assertions.assertEquals(
                "0:8080:8080",
        ...
        Assertions.assertEquals(
                "FFFF:CCCC:0",
                cell2.getCellStyle().getFillForegroundColorColor().getHexString());
        Assertions.assertEquals(
                "8080:0:0",
    ...
    private void fill(File file, File template) throws Exception {
        FastExcel.write(file, FillStyleData.class)
